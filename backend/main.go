...
func seedInitialData(db *gorm.DB) {
	...
	// Create default subscription plans (with AI tier and credits)
	plans := []models.Subscription{
		...
		},
		{
			...
			MaxListings:      25,
			MaxSubAgents:     2,
			Features:         "Up to 25 listings, 2 sub-agents, Subdomain access, Email support, AI assistant",
			IsActive:         true,
			AITier:           models.AITierBasic,
		...
		},
		{
			...
			MaxListings:      100,
			MaxSubAgents:     10,
			Features:         "Up to 100 listings, 10 sub-agents, Custom domain, Priority support, AI assistant",
			IsActive:         true,
			AITier:           models.AITierPro,
		...
		},
		{
			...
			MaxListings:      -1,
			MaxSubAgents:     -1,
			Features:         "Unlimited listings, Unlimited agents, Dedicated support, Advanced analytics, AI assistant",
			IsActive:         true,
			AITier:           models.AITierPro,
		...
		},
		{
			...
			Description:      "AI-powered team: descriptions, translation, pricing, priority support",
			Price:            7999,
			Duration:         30,
			MaxListings:      -1,
			MaxSubAgents:     -1,
			Features:         "Unlimited listings, Unlimited agents, AI writer & translator & pricing, Priority AI, Dedicated support",
			IsActive:         true,
			AITier:           models.AITierMillionaire,
