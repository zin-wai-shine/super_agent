...
const LocationPicker = ({ value, onChange, address }) => {
    ...
    return (
        <div className="relative h-full w-full">
            <div className="absolute top-4 left-4 right-4 z-10">
                ...
                >
                    <input
                        ...
                        className="w-full px-4 py-3 min-h-[44px] bg-white border border-gray-200 rounded-admin shadow-lg focus:outline-none focus:ring-2 focus:ring-primary-500 font-medium text-sm"
            ...
            <div className="absolute bottom-4 left-4 bg-white/90 backdrop-blur-sm px-3 py-1.5 rounded-admin shadow-sm border border-gray-100 text-[10px] font-bold text-gray-500 uppercase tracking-wider">
