                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                        <button
                                            ...
                                            className={`p-3 rounded-[3px] border transition-all flex flex-col items-center gap-2 ${collectionType === 'image' ? 'border-primary-500 bg-primary-50 dark:bg-primary-500/10' : 'border-gray-200 dark:border-gray-800 bg-white dark:bg-white/5 hover:border-gray-300'}`}
                                        >
                                        ...
                                        <button
                                            ...
                                            className={`p-3 rounded-[3px] border transition-all flex flex-col items-center gap-2 ${collectionType === 'icon' ? 'border-primary-500 bg-primary-50 dark:bg-primary-500/10' : 'border-gray-200 dark:border-gray-800 bg-white dark:bg-white/5 hover:border-gray-300'}`}
                                        >
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div className="space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="grid grid-cols-2 gap-3">
                                            <div className={`p-3 rounded-[3px] border transition-all flex flex-col items-center gap-2 ${collectionType === 'image' ? 'border-primary-500 bg-primary-50 dark:bg-primary-500/10' : 'border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-white/5 opacity-40'}`}>
                                                <PhotoIcon className={`w-5 h-5 ${collectionType === 'image' ? 'text-primary-600' : 'text-gray-400'}`} />
                                                <span className={`text-[10px] font-bold uppercase tracking-tight ${collectionType === 'image' ? 'text-primary-700' : 'text-gray-500'}`}>Image Based</span>
                                            </div>
                                            <div className={`p-3 rounded-[3px] border transition-all flex flex-col items-center gap-2 ${collectionType === 'icon' ? 'border-primary-500 bg-primary-50 dark:bg-primary-500/10' : 'border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-white/5 opacity-40'}`}>
