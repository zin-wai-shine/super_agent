                                                                ...
                                                                <div className="w-full px-12 py-10">
                                                                    <div className="grid grid-cols-4 gap-12 relative w-full px-12 items-center">
                                                                        ...
                                                                        <div className="relative rounded-2xl overflow-hidden min-h-[420px] group/locations-box shadow-lg">
                                                                            {/* Background Image */}
                                                                            <div
                                                                                className="absolute inset-0 bg-cover bg-center transition-transform duration-1000 group-hover/locations-box:scale-105"
                                                                                style={{ backgroundImage: 'url(/images/train_bg.png)' }}
                                                                            />
                                                                            {/* Dark overlay for readability */}
                                                                            <div className="absolute inset-0 bg-black/65" />
                                                                            {/* Content */}
                                                                            <div className="relative z-10 p-8 h-full flex flex-col items-start text-left space-y-8">
                                                                                ...
                                                                                <div className="flex flex-col gap-1 items-start">
                                                                                    {[
                                                                                        ...
                                                                                        <Link
                                                                                            key={link.name}
                                                                                            to={link.href}
                                                                                            className="group/link flex items-center px-4 py-3 rounded-xl transition-all animate-slide-in-right opacity-0 w-full hover:bg-white/10"
                                                                                            style={{ animationDelay: `${index * 50}ms`, animationFillMode: 'forwards' }}
                                                                                        >
                                                                                            <link.icon className="w-[18px] h-[18px] text-white/80 group-hover/link:text-white transition-all mr-5 stroke-[1.5]" />
                                                                                            <span className="text-[13px] font-semibold text-white group-hover/link:text-white transition-all mr-2">{link.name}</span>
                                                                                            <ChevronRightIcon className="w-3.5 h-3.5 text-white/40 group-hover/link:text-white group-hover/link:translate-x-2 transition-all duration-300 ml-auto" />
                                                                                        </Link>
                                                                                    ))}
                                                                                </div>
                                                                            </div>
