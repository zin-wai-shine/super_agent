                                ...
                                <div className="max-w-[1440px] mx-auto px-6 lg:px-12 py-10">
                                    <div className="grid grid-cols-4 gap-12 relative w-full px-12 items-start">
                                        ...
                                        <div className="flex flex-col items-start text-left">
                                            ...
                                            <div className="flex flex-col gap-1 items-start">
                                                <Link to="/contact" className="group/item menu-item-animate flex items-center px-4 py-3 rounded-xl transition-all cursor-pointer min-w-[280px]" style={{ animationDelay: '0ms' }}><MapPinIcon className="w-[18px] h-[18px] text-gray-700 group-hover/item:text-[var(--primary-color)] transition-all mr-5 stroke-[1.5]" /><ChevronRightIcon className="w-3.5 h-3.5 text-gray-400 group-hover/item:text-[var(--primary-color)] group-hover/item:translate-x-2 transition-all duration-300 mr-2" /><span className="text-[13px] font-semibold text-gray-800 group-hover/item:text-[var(--primary-color)] transition-all">View Office Location</span></Link>
                                            </div>
                                        </div>
                                        <div className="flex flex-col items-start text-left">
