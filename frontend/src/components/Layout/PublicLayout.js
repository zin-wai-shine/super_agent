                                                                        ...
                                                                        <div className="relative rounded-2xl overflow-hidden min-h-[420px] group/locations-box shadow-lg bg-[#111827]">
                                                                            ...
                                                                            <div className="relative z-10 p-8 h-full flex flex-col items-start text-left">
                                                                                <div className="flex items-center mb-6">
                                                                                    <FiMapPin className="w-5 h-5 text-white/70 mr-4" />
                                                                                ...
                                                                                <div className="flex flex-col gap-0.5 items-start w-full">
                                                                                    {[
                                                                                        ...
                                                                                        <Link
                                                                                            ...
                                                                                            style={{ animationDelay: `${index * 50}ms`, animationFillMode: 'forwards' }}
                                                                                        >
                                                                                            <link.icon className="w-[18px] h-[18px] text-white/90 group-hover/link:text-[var(--primary-color)] transition-all mr-5 stroke-[1.5]" />
                                                                                            <span className="text-[13px] font-semibold text-white group-hover/link:text-[var(--primary-color)] transition-all mr-2">{link.name}</span>
                                                                                            <ChevronRightIcon className="w-3.5 h-3.5 text-white/40 group-hover/link:text-[var(--primary-color)] group-hover/link:translate-x-2 transition-all duration-300 ml-auto" />
                                                                                        </Link>
                                                                                    ))}
                                                                                </div>
                                                                            </div>
