                        ...
                        <div className="flex flex-wrap gap-3" role="tablist" aria-label="Filter by status">
                            {[
                                ...
                                <button
                                    ...
                                    className={`min-h-[48px] px-6 py-2.5 rounded-2xl text-[15px] font-bold transition-all duration-300 active:scale-[0.96] border shadow-sm ${filter === value
                ...
                <div className="relative min-h-[400px]">
                    {initialLoading ? (
                        ...
                        <div className="flex flex-col items-center justify-center py-32 group animate-in fade-in duration-700">
                            ...
                            <Link
                                to="/listings"
                                className="inline-flex items-center gap-3 px-8 py-4 bg-slate-900 dark:bg-white text-white dark:text-dashboard-dark rounded-2xl font-bold transition-all duration-300 hover:scale-105 active:scale-95 shadow-xl shadow-slate-200 dark:shadow-none"
                            >
                                    ...
                                    >
                                        ...
                                        <div className="relative h-48 sm:h-56 w-full overflow-hidden shrink-0">
                                            ...
                                            <div className="absolute top-4 left-4 z-10">
                                                <div className={`flex items-center gap-2 px-3.5 py-1.5 rounded-2xl backdrop-blur-md border shadow-sm ${statusConfig.bgColor} ${statusConfig.textColor} border-white/20 dark:border-white/10`}>
                                            ...
                                            <div className="absolute top-4 right-4 z-10">
                                                <div className="px-2.5 py-1.5 bg-black/40 backdrop-blur-md border border-white/20 rounded-xl text-[10px] font-bold text-white/90 tabular-nums">
                                        ...
                                        <div className="flex-1 flex flex-col p-6 pt-5">
                                            ...
                                            <div className="flex items-center gap-2 mb-3">
                                                <span className="px-2 py-0.5 bg-slate-100 dark:bg-white/5 text-slate-500 dark:text-gray-400 text-[11px] font-bold rounded-lg uppercase tracking-wider">
