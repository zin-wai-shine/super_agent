                ...
                {(agent?.phone || agent?.email) && (
                    <div className="relative">
                        ...
                        <div className="space-y-6">
                            ...
                            {agent?.email && (
                                <a href={`mailto:${agent.email}`} className="flex items-center gap-4 group mt-5">
                                    ...
                                    <div>
                                        <p className="text-[11px] sm:text-[12px] text-slate-400 mb-0.5 font-medium">Email Address</p>
                                        <p className="text-[15px] sm:text-[16px] font-medium text-slate-900 dark:text-white">{agent.email}</p>
                                    </div>
                                </a>
                            )}
                        </div>
