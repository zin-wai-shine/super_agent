            ...
            <div className="w-full max-w-md">
                ...
                <div className="p-6 md:p-8">
                    <div className="text-center mb-6 md:mb-8">
                        <h1 className="text-[28px] md:text-2xl font-bold text-gray-900 mb-2">{t('authPages.welcomeBack')}</h1>
                        <p className="text-base md:text-sm text-gray-500">{t('authPages.signinDesc')}</p>
                    </div>
