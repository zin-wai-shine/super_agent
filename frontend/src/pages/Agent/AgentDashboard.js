        ...
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {filteredCards.map((stat) => (
                    <div key={stat.name} className="bg-white dark:bg-dashboard-card rounded-admin p-5 border-admin transition-all duration-300">
                        <div className="flex items-start justify-between">
                            ...
                            <div className={`p-2.5 rounded-admin ${stat.iconBg} backdrop-blur-md`}>
                    ...
                    <div className="bg-white dark:bg-dashboard-card rounded-admin p-6 border-admin">
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full text-left border-collapse divide-y divide-gray-100 dark:divide-gray-700">
                                <thead className="text-xs text-gray-500 dark:text-gray-400 bg-gray-50/50 dark:bg-gray-800/20">
                                    <tr>
                                        <th className="px-4 py-3 font-medium rounded-l-admin">Property</th>
                                        <th className="px-4 py-3 font-medium">Price</th>
                                        <th className="px-4 py-3 font-medium">Status</th>
                                        <th className="px-4 py-3 font-medium rounded-r-admin">Action</th>
                                    </tr>
                                </thead>
                                        ...
                                        <tr key={listing.id} className="group hover:bg-gray-50 dark:hover:bg-gray-800/30 transition-colors">
                                            <td className="px-4 py-4">
                                                <div className="flex items-center space-x-3">
                                                    <div className="w-12 h-12 rounded-admin bg-gray-200 dark:bg-gray-700 overflow-hidden flex-shrink-0">
                                                        {listing.images?.[0] ? (
                    ...
                    <div className="bg-white dark:bg-dashboard-card rounded-admin p-6 border-admin">
                        ...
                        <div className="space-y-3">
                             <Link to="/dashboard/listings/new" className="flex items-center p-3 rounded-admin hover:bg-gray-50 dark:hover:bg-primary-500/10 transition-colors group">
                                <div className="p-2 bg-primary-50 dark:bg-primary-600/15 text-primary-600 dark:text-primary-400 rounded-admin group-hover:scale-110 transition-transform">
                            ...
                            <Link to="/dashboard/users" className="flex items-center p-3 rounded-admin hover:bg-gray-50 dark:hover:bg-purple-500/10 transition-colors group">
                                <div className="p-2 bg-purple-50 dark:bg-purple-600/15 text-purple-600 dark:text-purple-400 rounded-admin group-hover:scale-110 transition-transform">
