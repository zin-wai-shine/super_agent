            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-4">
                ...
                <div className="flex flex-wrap items-center justify-center gap-4 flex-1">
                    ...
                    <div className="relative w-full sm:w-56" ref={datePickerRef}>
                        ...
                        {showDatePicker && (
                            <div className="absolute top-full left-0 lg:left-auto lg:right-0 mt-2 z-[100] bg-white dark:bg-dashboard-card rounded-[3px] shadow-xl border border-gray-100 dark:border-gray-700 overflow-hidden w-[350px]">
