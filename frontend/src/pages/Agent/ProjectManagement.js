...
const ProjectManagement = () => {
    const { user } = useAuth();
    const canCreate = hasActionPermission(user, 'projects:create');
    const canUpdate = hasActionPermission(user, 'projects:update');
    const canDelete = hasActionPermission(user, 'projects:delete');
